...
# ✅ OpenAI GPT-3.5-turbo 直连配置
OPENAI_API_BASE = "https://api.openai.com/v1"  # OpenAI官方API地址
OPENAI_API_KEY = ""  # 替换为你的有效OpenAI API密钥
...
RESULT_CSV = "gpt35_test_predictions.csv"  # 使用CSV格式保存结果
LOG_FILE = "processing_log.txt"
PROGRESS_FILE = "progress_checkpoint.txt"
MODEL_NAME = "gpt-4o-mini"  # 模型名称     gpt-4o-mini    gpt-3.5-turbo
